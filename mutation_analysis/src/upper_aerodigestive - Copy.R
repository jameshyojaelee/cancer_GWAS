...
xx <- sort(table(upper_aerodigestive_mut_final$Hugo_Symbol),decreasing=TRUE)[1:10]
xx
#                  

upper_aerodigestive_C4orf21 <- upper_aerodigestive_mut_final[which(upper_aerodigestive_mut_final$Hugo_Symbol == "C4orf21"), ]
upper_aerodigestive_no_C4orf21 <- upper_aerodigestive_mut_final[which(upper_aerodigestive_mut_final$Hugo_Symbol != "C4orf21"), ]

#find the most frequent variant type
calculate_mode(upper_aerodigestive_C4orf21$Variant_Classification)
#turns out to be Missense_Mutation

#create subset with C4orf21_Missense
upper_aerodigestive_C4orf21_Mis <- upper_aerodigestive_C4orf21[which(upper_aerodigestive_C4orf21$Variant_Classification == "Missense_Mutation"), ]
upper_aerodigestive_C4orf21_No_Mis <- upper_aerodigestive_C4orf21[which(upper_aerodigestive_C4orf21$Variant_Classification != "Missense_Mutation"), ]
upper_aerodigestive_C4orf21 <- droplevels(upper_aerodigestive_C4orf21)
#7 cell lines with C4orf21 Missense_Mutation

#subset of all ccl
upper_aerodigestive_ccl <- distinct(upper_aerodigestive_mutation, ccl, .keep_all= TRUE )

y <- length(upper_aerodigestive_C4orf21_Mis$ID)
x <- length(upper_aerodigestive$ccl)
x <- x - y


final_table <- data.frame(mutation = c("C4orf21", "other"), counts = c(y, x))

bar_title <- paste("Mut: C4orf21 Missense_Mutation \n", y, "overlaps out of", x, "total")
...
upper_aerodigestive_ccl[match(upper_aerodigestive_C4orf21$ID, upper_aerodigestive_ccl$ID), ] <- upper_aerodigestive_C4orf21

upper_aerodigestive_ccl$Hugo_Symbol <- as.character(upper_aerodigestive_ccl$Hugo_Symbol)

upper_aerodigestive_ccl$Hugo_Symbol[upper_aerodigestive_ccl$Hugo_Symbol == "C4orf21"] <- "has Mut"
